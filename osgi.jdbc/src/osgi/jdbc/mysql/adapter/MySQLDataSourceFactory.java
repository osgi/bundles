...
@Component(properties={"osgi.jdbc.driver.class=com.mysql.jdbc.Driver",
"osgi.jdbc.driver.name=MySql", "osgi.jdbc.driver.version=5.1.25"})
public class MySQLDataSourceFactory implements DataSourceFactory {
	...
	private <T extends MysqlDataSource> T setProperties(T ds,
		...
		if ( password != null && user != null) {
			...
			throw new SQLException("If you set the user for this connection you must also set the password: " + url + " for " + user);
